...
class DynamicRelations extends Widget
{
	...
	public function run(){
		...
		$hash = crc32($key);
		Yii::$app->session->set('dynamic-relations-'.$hash, [ 'path'=>$this->viewPath, 'cls'=>$type , 'params' => $this->params , 'panelId' => $this->panelId , 'header' => $this->header , 'boxClass' => $this->boxClass]);
